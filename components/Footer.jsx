...
export default function Footer() {
  ...
  return (
    <footer className="w-[min(1280px,92%)] mx-auto mt-28 mb-12 pt-12 border-t border-white/10">
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-8 pb-10">
        <div>
          <div className="flex items-center gap-3 mb-2">
            <span className="font-serif text-2xl font-semibold text-white">Sanjay Kumar Dupati</span>
        ...
        <div className="flex flex-col items-start md:items-end gap-1.5 font-mono text-xs">
          <div className="glossy-chip px-3.5 py-1.5 rounded-full flex items-center gap-2 text-slate-200 font-medium">
          ...
          <span className="text-[11px] text-slate-400">AVAILABLE FOR SELECT COLLABORATIONS</span>
        </div>
      </div>

      <div className="flex flex-col sm:flex-row items-center justify-between gap-4 pt-6 border-t border-white/10 font-mono text-[11px] text-slate-400">

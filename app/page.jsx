...
export default function HomePage() {
  ...
  return (
    <div className="relative w-full">
      ...
      <main className="w-[min(1280px,94%)] mx-auto px-1 sm:px-0">
        {/* =========================================
            1. HERO SECTION WITH 3D CANVAS
           ========================================= */}
        <section id="hero" className="min-h-[calc(100vh-120px)] pt-6 sm:pt-12 pb-12 sm:pb-16 grid grid-cols-1 lg:grid-cols-[1.15fr_0.85fr] items-center gap-8 lg:gap-12">
          {/* Hero Copy */}
          <div className="relative z-10 max-w-2xl">
            {/* Eyebrow & Status Chips */}
            <div className="flex flex-wrap items-center gap-2 sm:gap-3 mb-4 sm:mb-6">
              <span className="glossy-chip text-blue-300 font-mono text-[10px] sm:text-xs tracking-wider uppercase font-bold flex items-center gap-1.5 sm:gap-2 px-3 sm:px-4 py-1.5 rounded-full">
              ...
              <span className="glossy-chip font-mono text-[10px] sm:text-[11px] text-teal-300 tracking-wider uppercase font-semibold px-3 sm:px-3.5 py-1.5 rounded-full flex items-center gap-1.5">
            ...
            <motion.h1
              ...
              className="text-4xl xs:text-5xl sm:text-7xl lg:text-8xl font-serif leading-[0.96] sm:leading-[0.92] tracking-tight text-white font-normal"
            >
              Systems for<br />
            ...
            <motion.p
              ...
              className="mt-5 sm:mt-8 text-sm sm:text-base lg:text-lg text-slate-300 max-w-lg font-sans leading-relaxed"
            >
            ...
            <motion.div
              ...
              className="mt-7 sm:mt-10 flex flex-col xs:flex-row items-stretch xs:items-center gap-3 sm:gap-4"
            >
              <Link
                href="/projects"
                className="glossy-pill-blue px-6 sm:px-7 py-3 sm:py-3.5 rounded-full font-mono text-xs tracking-widest uppercase flex items-center justify-center gap-2 shadow-xl hover:scale-105 transition-transform text-center"
              >
              ...
              <a
                href="#agent-terminal"
                className="glossy-chip px-5 sm:px-6 py-3 sm:py-3.5 rounded-full font-mono text-xs tracking-widest uppercase text-slate-200 hover:text-white flex items-center justify-center gap-2 text-center"
              >
        ...
        {/* =========================================
           ...
           ========================================= */}
        <section className="w-full overflow-hidden border-y border-white/10 my-10 sm:my-16 py-3 sm:py-4 bg-white/[0.02] backdrop-blur-md">
          <motion.div
            animate={{ x: ['0%', '-50%'] }}
            transition={{ duration: 30, repeat: Infinity, ease: 'linear' }}
            className="flex whitespace-nowrap font-mono text-[11px] sm:text-xs tracking-widest uppercase text-slate-400 font-medium gap-8"
          >
            {[...Array(2)].map((_, i) => (
        ...
        {/* =========================================
           ...
           ========================================= */}
        <section id="agent-terminal" className="py-12 sm:py-20 border-b border-white/10">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 sm:gap-6 mb-8 sm:mb-10">
            <div>
              <p className="text-blue-400 font-mono text-[11px] sm:text-xs tracking-widest uppercase font-bold flex items-center gap-2 mb-2">
                <Terminal size={15} /> Autonomous Agent Runtime Simulation
              </p>
              <h2 className="text-3xl xs:text-4xl sm:text-5xl font-serif text-white tracking-tight">
                Live <em className="italic text-blue-400 font-serif">Model Context Protocol</em> Execution
              </h2>
            </div>
            <p className="text-xs sm:text-sm font-sans text-slate-400 max-w-md leading-relaxed">
        ...
        {/* =========================================
           ...
           ========================================= */}
        <section className="py-14 sm:py-24 grid grid-cols-1 lg:grid-cols-[0.85fr_1.15fr] gap-8 lg:gap-14 items-center border-b border-white/10">
          <div>
            <p className="text-blue-400 font-mono text-xs tracking-widest uppercase font-bold mb-3 sm:mb-4">
              Engineering Manifesto
            </p>
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-serif text-white leading-tight tracking-tight">
              Good software makes the <em className="italic text-blue-400 font-serif">complicated</em> feel inevitable.
            </h2>
          </div>
          <div className="space-y-4 sm:space-y-6 text-slate-300 text-sm sm:text-base leading-relaxed font-sans">
            <p>
        ...
        <section id="work" className="py-16 sm:py-24">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-5 sm:gap-6 mb-8 sm:mb-12">
            <div>
              ...
              <h2 className="text-3xl xs:text-4xl sm:text-5xl lg:text-6xl font-serif text-white tracking-tight">
            ...
            <div className="flex flex-wrap gap-1.5 sm:gap-2 font-mono text-[11px] sm:text-xs">
              {['All', 'AI', 'Deep Learning', 'Machine Learning', 'Web Development'].map((tab) => (
                <button
                  ...
                  className={`px-3 sm:px-4 py-1.5 sm:py-2 rounded-full font-bold transition-all cursor-pointer ${
                    activeTab === tab
                      ? 'glossy-pill-blue'
                      : 'glossy-chip'
                  }`}
          ...
          <div className="mt-10 sm:mt-14 text-center">
            <Link
              href="/projects"
              className="glossy-pill-blue inline-flex items-center justify-center gap-3 px-6 sm:px-8 py-3.5 sm:py-4 rounded-full font-mono text-xs uppercase tracking-widest font-bold shadow-2xl hover:scale-105 transition-transform text-center max-w-full"
            >
        ...
        {/* =========================================
           ...
           ========================================= */}
        <section id="capabilities" className="py-16 sm:py-24 border-t border-white/10">
          <div className="text-center max-w-2xl mx-auto mb-8 sm:mb-10">
            ...
            <p className="text-slate-400 text-xs sm:text-sm mt-2 sm:mt-3 font-sans">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mt-8 sm:mt-12">
            <div className="glossy-glass-card p-5 sm:p-6 rounded-2xl sm:rounded-3xl">
        ...
        {/* =========================================
           ...
           ========================================= */}
        <section id="profile" className="py-16 sm:py-24 border-t border-white/10">
          <p className="text-blue-400 font-mono text-xs tracking-widest uppercase font-bold mb-3 sm:mb-4">
            Education & Recognition
          </p>

          <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 sm:gap-8 mb-6 sm:mb-12">
            {/* Degree 1 */}
            <div className="glossy-glass-card p-5 sm:p-8 rounded-2xl sm:rounded-3xl">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6">
            <div className="glossy-glass-card p-5 sm:p-6 rounded-2xl sm:rounded-3xl">
              <b className="font-serif text-lg sm:text-xl font-bold text-blue-300 block mb-2">
            ...
            <div className="glossy-glass-card p-5 sm:p-6 rounded-2xl sm:rounded-3xl">
              <b className="font-serif text-lg sm:text-xl font-bold text-teal-300 block mb-2">
            ...
            <div className="glossy-glass-card p-5 sm:p-6 rounded-2xl sm:rounded-3xl">
              <b className="font-serif text-lg sm:text-xl font-bold text-rose-300 block mb-2">
                59th Statewide Rank
              </b>
              <p className="text-xs font-sans text-slate-300 leading-relaxed">
        ...
        {/* =========================================
            9. CONTACT LOUNGE
           ========================================= */}
        <section id="contact" className="py-16 sm:py-28 border-t border-white/10">
          <p className="text-blue-400 font-mono text-xs tracking-widest uppercase font-bold mb-3 sm:mb-4">
            Begin a conversation
          </p>
          <h2 className="text-4xl xs:text-6xl sm:text-7xl lg:text-8xl font-serif text-white tracking-tight leading-none max-w-4xl">
            Let’s make<br />
            something <em className="italic text-blue-400 font-serif">matter.</em>
          </h2>

          <div className="mt-8 sm:mt-12 flex flex-col xs:flex-row items-stretch xs:items-center gap-3.5 sm:gap-5">
            <a
              onClick={handleConfetti}
              href="mailto:sanjaykumardupati6@gmail.com"
              className="glossy-pill-blue px-6 sm:px-8 py-3.5 sm:py-4 rounded-full font-mono text-xs uppercase tracking-widest font-bold shadow-xl hover:scale-105 transition-transform flex items-center justify-center gap-2 cursor-pointer text-center"
            >
              <Mail size={16} />
            ...
            <button
              ...
              className="glossy-chip px-5 sm:px-7 py-3.5 sm:py-4 rounded-full font-mono text-xs uppercase tracking-widest font-bold text-slate-200 hover:text-white flex items-center justify-center gap-2 cursor-pointer text-center"
            >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-5 sm:gap-6 pt-8 sm:pt-12 mt-10 sm:mt-16 border-t border-white/10 text-xs font-mono text-slate-400">
            <div>
              <span className="text-slate-500 block mb-1">DIRECT INBOX</span>
              <a href="mailto:sanjaykumardupati6@gmail.com" className="text-slate-200 font-bold hover:text-blue-400 break-all sm:break-normal">
